- [English](https://docs.codescoring.ru/agent/config.en/index.md)
...
- [2024.52.0](/changelog/on-premise-changelog/#2024520-2024-12-28) **branch-or-tag** – ссылка на ветку репозитория или тег, например `refs/tags/v1.0` (для команд `scan dir` и `scan file`);
- [2024.52.0](/changelog/on-premise-changelog/#2024520-2024-12-28) **commit** – хэш коммита в системе контроля версий (для команд `scan dir` и `scan file`);
- [2024.52.0](/changelog/on-premise-changelog/#2024520-2024-12-28) **hash** – хэш образа (для команды `scan image`);
- [2025.7.0](/changelog/on-premise-changelog/#202570-2025-02-14) **cloud-resolve** – использование разрешения зависимостей в облаке. По умолчанию значение `false`.
...
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **gitleaks-path** – путь к исполняемому файлу gitleaks, который будет использоваться при сканировании;
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **gl-secrets-report** – включение формирования отчета о найденных секретах в формате GitLab. По умолчанию `false`;
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **gl-secrets-report-filename** – имя формируемого файла для отчета в формате GitLab. По умолчанию `gl-secrets-report.json`.

### Параметры [инструмента поиска секретов Gitleaks](https://github.com/gitleaks/gitleaks?tab=readme-ov-file#readme)

- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **baseline-path** – путь к baseline файлу отчета gitleaks. Все обнаруженные ранее секреты, зафиксированные в этом файле, будут проигнорированы при повторном сканировании;
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **enable-rule** – список ID правил, которые будут **включены** при сканировании;
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **gitleaks-ignore-path** – путь к файлу .gitleaksignore или директории, содержащей его. По умолчанию `.` (текущая директория);
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **ignore-gitleaks-allow** – игнорирование комментариев gitleaks:allow. По умолчанию `false`;
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **log-level** – уровень логирования. Возможные значения: `trace, debug, info, warn, error, fatal`. По умолчанию `info`;
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **max-decode-depth** – максимальная глубина рекурсивного декодирования. Значение `0` отключает декодирование;
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **max-target-megabytes** – максимальный размер файлов (в мегабайтах), которые будут обрабатываться. Файлы, превышающие этот размер, будут пропущены. По умолчанию 0 (ограничение отсутствует);
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **no-banner** – отключение баннера gitleaks при запуске. По умолчанию `false`;
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **no-color** – отключение цветного вывода для подробного (verbose) режима. По умолчанию `false`;
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **redact** – маскирование найденных секретов в логах и консоли. Значение 0 полностью отображает секреты, 100 – полностью скрывает. Можно задать промежуточное значение, например, 20 (маскирует 20% секрета). По умолчанию `0`;
- [2025.13.0](/changelog/on-premise-changelog/#2025130-2025-03-28) **verbose** – включение подробного (verbose) вывода при сканировании. По умолчанию `false`.
