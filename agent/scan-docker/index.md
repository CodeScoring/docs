- [English](https://docs.codescoring.ru/agent/scan-docker.en/index.md)
...
Команда **scan image** имеет четыре уникальных параметра, помимо [общих настроек команды сканирования](/agent/scan/#_2):

- `--hash` – указание хэша образа;
- `--scan-files` – сканирование файлов в образе.
