- [English](https://docs.codescoring.ru/tqi/viewing-results.en/index.md)
...
- **Продолжительность** - количество месяцев от времени первого коммита до времени последнего изменения;
...
- **Новизна** - доля добавленных строк кода относительно общего количества строк кода в репозитории;
- **Рефакторинг** - доля измененных и удаленных строк кода относительно общего количества строк кода в репозитории;
...
Историю проекта можно отследить по графикам, показывающим динамику проекта по следующим параметрам:
...
Кроме этого, оценить влияние изменений на проект можно по следующим параметрам:

- Темп;
- Скорость;
- Плотность.

Временной промежуток на графиках можно менять с помощью слайдера, выбирая интересующий период для анализа.
