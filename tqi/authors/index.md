...
- **Новизна** - доля добавленных строк кода относительно общего количества строк кода, написанных автором;
- **Рефакторинг** - доля измененных и удаленных строк кода относительно общего количества строк кода, написанных автором;
