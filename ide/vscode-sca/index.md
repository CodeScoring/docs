- [English](https://docs.codescoring.ru/ide/vscode-sca.en/index.md)
...
1. **Откройте панель алертов**: Используйте кнопку **Open Alerts View** в боковом меню плагина для открытия окна со списком алертов по сработавшим политикам
