- [English](https://docs.codescoring.ru/on-premise/postgres-upgrade-compose.en/index.md)
...
Корректный порядок обновления

Не рекомендуется выполнять обновление инсталляции и базы данных одновременно. Обновление следует проводить последовательно: сначала обновить инсталляцию и убедиться в корректной работе сервиса, после чего выполнять обновление базы данных.
