- [English](https://docs.codescoring.ru/on-premise/variables-extended.en/index.md)
...
- **SENTRY_DSN** - идентификатор проекта внутри Sentry, в который будут отправляться данные;
