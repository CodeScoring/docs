- [Русский](https://docs.codescoring.ru/on-premise/containers-description/index.md)
...
- **Tasks-sca-external-scan** – a queue for scans initiated via the Johnny console agent;
...
- **Judge** - responsible for policy enforcement within the OSA Proxy service.
