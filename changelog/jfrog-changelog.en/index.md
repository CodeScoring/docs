- [Русский](https://docs.codescoring.ru/changelog/jfrog-changelog/index.md)
...
- Added new execution `codeScoringVersion`, allowing to find out the plugin version. To do this, run the command: `curl http://localhost:8082/artifactory/api/plugins/execute/codeScoringVersion`. If the version is not displayed, restart JFrog
