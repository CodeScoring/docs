...
![Vuln reachability](/assets/img/vuln-reachability.png)
...
Справа отображается агрегированная оценка уровня угрозы по шкале CVSS с указанием версии (CVSS v3 и/или CVSS v2) и соответствующего уровня угрозы.
...
![Vuln sources](/assets/img/vuln-data-sources.png)
...
![Vuln dependencies](/assets/img/vuln-dependencies.png)
...
![Vuln alerts](/assets/img/vuln-alerts.png)
...
![Vuln additional](/assets/img/vuln-additional.png)
