...
#### 6.1 Example Usage of CodeScoring Scan Configuration
...
- **By Severity -> Location** (default): By severity level, subgrouped by package
- **By Severity -> Package (PURL)**: By severity level, subgrouped by package name alphabetically
...
##### 7.1.8 Settings and Customization
