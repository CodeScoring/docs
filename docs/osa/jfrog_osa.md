...
- **storeScanProperties** - сохранение причины блокировки и отметки о времени сканирования в свойства артифакта 
- **defaults** – настройки сканирования по умолчанию для всех подключенных репозиториев
  ...
  - **skipScanUser** – пользователь, для которого пропускается сканирование компонентов. Необходима для того, чтобы сам CodeScoring мог забрать компонент для сканирования.
  ...
  - **deleteBlocked** - удалять заблокированный политиками артифакт
