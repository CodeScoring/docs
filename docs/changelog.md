...
- Добавлена информация о пакете в таблицы Policy alerts и Vulnerabilities на странице заблокированного в OSA образа
- Добавлен фильтр Group в разделе Vulnerabilities
- Переименован признак политики Blocks build в Blocker
- Ускорен анализ CLI проектов в ситуации, когда зависимости анализируемого проекта часто встречаются в других проектах
- Ускорена загрузка информации о похожих авторов
