...
- Разделена информация по проекту на модули SCA и TQI
...
- Добавлен баннер CodeScoring и логирование версии в консоль при запуске
- Добавлены метрики про количество запущенных анализов для Prometheus
...
- Улучшен парсинг env для манифестов Rubygem
- Доработан механизм объединения ячеек в таблице при выводе в консоль
