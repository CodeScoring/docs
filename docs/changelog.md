...
- Добавлена возможность скачивания PDF-отчета с результатами сканирования проекта
...
- Добавлен новый режим работы `spectator` 
- Добавлена поддержка сканирования мультиплатформенных Docker-образов
- Файл для настройки плагина теперь использует расширение `.yaml`
- Добавили возможность изменения значений по умолчанию в файле для настройки
