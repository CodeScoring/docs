...
- Добавлена возможность скачивания PDF-отчета по скану проекта
- Добавлена поддержка анализа зависимостей Rust
...
- Добавлен поиск по вложенным уязвимостям в разделе Vulnerabilities
