...
- Добавлена возможность блокировки скачивания образов из Sonatype Nexus Repository при несоответствии политикам безопасности
...
- Дополнена схема обновления на [актуальную версию продукта](/on-premise/update).
...
- Исправлена ошибка сохранения результатов сканирования при отсутствии нужных полей
...
- Добавлена опция сохранения результатов сканирования артефакта
- Добавлена команда в API для извлечения результатов сканирования артефакта

### [2023.26.0] - 2023-06-30

- Добавлена поддержка hosted репозиториев
...
- Добавлена настройка HTTP Client Connection Pool Size в конфигурации плагина
