...
- Добавлена возможность скачать SBOM по проекту в формате CycloneDX
- Добавлена загрузка SBOM в формате CycloneDX в CLI-проекты
- Добавлена возможность проведения анализа на CLI-проекте
