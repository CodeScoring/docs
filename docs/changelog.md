...
- Добавлены новые условия политики - по наличию эксплойта уязвимости и вектору атаки
...
- Изменен метод API `/api/dependencies/csv/` на метод `/api/dependencies/by_project/csv/`
