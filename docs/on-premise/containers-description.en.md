...
- **Judge** - responsible for making decisions regarding blocking components or container images (validating whithing configured policies within CodeScoring) during the operation of the CodeScoring system service - OSA Proxy.