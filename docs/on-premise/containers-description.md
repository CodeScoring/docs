...
- **Judge** - отвечает за принятие решения о блокировке компонента или контейнерного образа (сверяется с настроенными политиками внутри CodeScoring), во время работы сервиса системы CodeScoring - OSA Proxy.