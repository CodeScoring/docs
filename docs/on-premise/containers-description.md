...
В данном разделе представлен обзор основных служб, формирующих инфраструктуру системы. Описаны их функционал и роли в обеспечении работы платформы.
...
-   **Tasks-osa-container-image-scan** - отвечает за сканирование образов в стандартах OCI и Docker на предмет уязвимостей;
...
-   **Tasks-tqi** - агент модуля CodeScoring TQI (Technical Quality Index), анализирующий качество исходного кода;
