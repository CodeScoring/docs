...
CLI-проект не имеет привязки к репозиторию.

CLI-проекты используются в двух основных сценариях:

1. Формирование SBOM сторонним инструментом и загрузка его в систему.
2. Сохранение результатов сканирования от консольного агента johnny.
