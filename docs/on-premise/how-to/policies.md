...
Для создания задачи или отправки email необходимо выбрать один или несколько алертов и нажать соответствующую кнопку. Например, так:

![New task](/assets/img/alerts_new_task.png) ![Send email](/assets/img/alerts_send_email.png)
