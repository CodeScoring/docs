...
- **Глубина транзитивности зависимости** - контролирует глубину поиск зависимостей. При достижении заданной глубины поиск прерывается вне зависимости от результата;
