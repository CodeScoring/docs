...
Примечание для параметра **Зависимость опасна**. Зависимость считается опасной, если у нее есть уязвимости с:
...
- одним из следующих возможных результатов эксплуатации уязвимости (Kaspersky):
  - Вредоносное ПО;
  - Другое влияние.
