...
Условия политики можно объединять в группы (**Group**) с помощью логических выражений **AND/OR**.
...
Для создания такой политики необходимо добавить две группы, объединенные выражением **OR**. Это значит, что политика сработает при соответствии любой из перечисленных групп условий. Внутри группы задаются условия (**Rule**), объединенные выражением **AND**.
