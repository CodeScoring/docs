...
| **Analysis**: set Secrets status                                    | :material-minus:{ .icon_check }                | :material-minus:{ .icon_check }                c| :material-check-circle-outline:{ .icon_check } | :material-minus:{ .icon_check }                | :material-check-circle-outline:{ .icon_check } | :material-check-circle-outline:{ .icon_check } |
