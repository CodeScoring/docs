...
- **Язык** — язык интерфейса системы. Возможные значения: `Русский`, `English`;
- **Формат чисел** — отображение чисел в системе. Возможные значения: `1 000,33`, `1.000,33`, `1,000.33`, `1`000.33`;
- **Формат дат** — отображение дат в системе. Возможные значения: `DD/MM/YYYY`, `MM/DD/YYYY`, `YYYY-MM-DD`, `DD.MM.YYYY`.
