...
- **Dependency Transitivity depth** - controls the depth of the dependency search. When the specified depth is reached, the search is interrupted regardless of the result;
