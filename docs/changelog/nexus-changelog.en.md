...
- Added support for PHP composer repositories (works with installation of the [community plugin](https://github.com/sonatype-nexus-community/nexus-repository-composer/tree/master))
