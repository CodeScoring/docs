...
- <span class="module-tag osa">OSA</span> Оптимизировано сканирование OSA-пакетов
- Исравлена работа с игнорами в отдельном сервисе работы с политиками

#### Изменено

- <span class="module-tag osa">OSA</span> Изменена детализация логиварония работы OSA
