...
- Исправлена ошибка, из-за которой в выгружаемых SBOM не проставлялась метка `vulnerability_is_reachable` для уязвимостей
- Исправлена ошибка сканирования системных пакетов с одинаковыми названиями и версиями, но разными квалификаторами
- Исправлена ошибка анализов проектов с опцией поиска зависимостей по хэшам
- Оптимизирована работа раздела с группами проектов
...
- <span class="data-tag secrets">Data</span> Добавлен сбор исправленных версий для компонентов из блока "Возможные меры по устранению уязвимости" БДУ ФСТЭК
...
- <span class="data-tag secrets">Data</span> Исправлены некорректные версии БДУ ФСТЭК с символом "Х" и запятыми
