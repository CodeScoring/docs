...
- Добавлены разные режими отправки уведомлений на email и создания задач в Jira в рамках действий с политиками: по одному на алерт или дайджестом на сканирование
- Добавлена обработка результатов анализа секретов при работе с модулем через CLI с помощью консольного агента johnny
- Добавлена кнопка пересчёта информации о секретах в разделе менеджмента модели машинного обучения `Настройки -> Режимы работы`
...
- Добавлено скрытией взаимоисключающих полей Access Token и SSH Key при разных режимах настройки подключения к VCS для избежания неправильной валидации 
