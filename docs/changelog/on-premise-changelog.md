...
- Добавлен автоматический выбор типа авторизации для реестров контейнерных образов

#### Исправлено

- Оптимизирован запрос получения списка проектов на странице зависимости
