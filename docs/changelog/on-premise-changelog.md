...
- <span class="api-tag">API</span> В ответах API строковые значения `True` / `False` приведены к булевым `true` / `false`
...
- <span class="module-tag sca">SCA</span> Исправлена фильтрация по булевым типам в группах SCA-проектов
