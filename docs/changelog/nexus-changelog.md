...
- Плагин теперь разрешает загрузку образов при несконфигурированном реестре (registry) в инсталляции CodeScoring, если флаг `Block downloads in case of plugin or CodeScoring errors` отключен.

### [2025.23.0] - 2025-06-02

- Добавлена опция выставить timeout на ожидание ответа от инсталляции в общей конфигурации плагина
