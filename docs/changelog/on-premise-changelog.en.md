...
- <span class="data-tag secrets">Data</span> Added fixed-version collection for components from the 'Possible Mitigation Measures' section of the FSTEC BDUs
...
- <span class="data-tag secrets">Data</span> Fixed incorrect FSTEC BDU versions with "X" symbol and commas
