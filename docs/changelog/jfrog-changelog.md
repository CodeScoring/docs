...
- Политики применяются в зависимости от репозитория, в который пришел запрос (virtual/remote): в запрос в CodeScoring теперь отправляется фактическое имя репозитория
