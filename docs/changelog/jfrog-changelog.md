...
- В плагин добавлен механизм Circuit Breaker, предотвращающий деградацию производительности Artifactory при недоступности или таймаутов со стороны CodeScoring.
