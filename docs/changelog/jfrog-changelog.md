...
#### Исправлено
- Ошибка с двойными запросами в OSA для не заблокированных пакетов.
- Переход Circuit Breaker в состояние OPEN, когда сервер молча закрывал соединения из connection pool плагина.

#### Добавлено
- Обработка неблокирующего статуса `delayed`
