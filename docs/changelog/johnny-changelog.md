...
- Изменена идентификация уязвимостей в формате sarif для лучшего отображения в DefectDojo
- Изменена выгрузка severity и тэгов в формате sarif для лучшего отображения в DefectDojo
- Исправлена ошибка сканирования bom с пакетами golang
- Исправлена ошибку при парсинге пустого `cargo.lock`
