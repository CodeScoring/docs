...
- Добавлен анализ достижимости уязвимостей для Java и графа вызовов Svace (начиная с версии 2025.37.0 инсталляции)
...
- Добавлена проверка возможности запуска команды и получения результата анализа в соответствии с лицензией инсталляции перед выполнением сканирования
- Добавлена возможность выбора типа прогресс-бара ('spinner' по умолчанию, 'text')
#### Изменено
