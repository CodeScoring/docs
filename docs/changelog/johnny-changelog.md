...
#### Добавлено
- Добавлен вывод matched criteria в отображении алертов политик (начиная с версии 2025.45.0 инсталляции) 
...
- Добавлена поддержка `Go` и `python` в анализе достижимости 
...
#### Изменено
- Добавлено ограничение на вывод путей достижимости в таблице. Теперь выводится 5 путей и количество не отображенных 
