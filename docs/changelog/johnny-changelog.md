...
- Добавлена возможность указать группу при создании CLI проекта
- Добавлена возможность указания формата генерируемого SBoM
...
- Исправлена ошибку `unsupported type` для composer компонентов в команде `scan bom`
