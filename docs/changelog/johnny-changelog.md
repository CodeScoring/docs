...
- Добавлена команда `scan build ebpf` для сканирования сборки C/C++ проектов с использванием eBPF
- Добавлена выгрузка в sarif данных о связи зависимости вида `results.properties.relation: direct|indirect`
