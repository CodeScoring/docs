...
- интеграцию с менеджерами репозиториев и реестрами контейнерных образов: **Nexus Repository Manager**, **JFrog Artifactory Pro**, **Harbor**, **GitLab**, **GitFlic**, **ИТ-Платформа СФЕРА**;
