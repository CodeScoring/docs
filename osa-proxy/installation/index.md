- [English](https://docs.codescoring.ru/osa-proxy/installation.en/index.md)
...
1. Создать secret для доступа к приватному реестру Docker-образов, используя адрес (`REGISTRY_URL`), логин (`USERNAME`) и пароль (`PASSWORD`), полученные от вендора.
