- [English](https://docs.codescoring.ru/osa-proxy/base64-url.en/index.md)
...
1. Выберите желаемый тип (например, `maven2 (proxy)`).
1. В поле **Remote storage** введите URL вашего экземпляра `osa-proxy`, включая имя репозитория и параметры, закодированные в Base64.
...
1. В конфигурации установите поле **URL** на URL `osa-proxy`. Этот URL должен включать имя репозитория и строку, закодированную в Base64.
...
1. **Закодировать строку с использованием URL-safe Base64.**
