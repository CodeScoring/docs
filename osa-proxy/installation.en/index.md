- [Русский](https://docs.codescoring.ru/osa-proxy/installation/index.md)
...
1. Create a secret to access the private Docker registry, using the address (`REGISTRY_URL`), login (`USERNAME`) and password (`PASSWORD`) received from the vendor.
