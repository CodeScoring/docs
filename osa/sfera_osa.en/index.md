- [Русский](https://docs.codescoring.ru/osa/sfera_osa/index.md)
...
1. (*Optional*) To manage enabling/disabling of plugins, you can create `enabled.txt` or `disabled.txt` files in the `plugins` folder.
