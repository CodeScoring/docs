- [English](https://docs.codescoring.ru/osa/sfera_osa.en/index.md)
...
1. (*Опционально*) Для управления включением/отключением плагинов можно создать в папке `plugins` файлы `enabled.txt` или `disabled.txt`.
